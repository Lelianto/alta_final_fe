...
class Home extends React.Component {
	...
	state = {
		...
		article : ['Lorem ipsum dolor sit amet consectetur adipisicing elit', 'Alias corrupti velit illum sequi quas omnis esse ipsam sed aut delectus blanditiis', 'Deserunt dolor temporibus enim deleniti a!', 'Pariatur exercitationem atque non excepturi, cum', 'reiciendis mollitia error maxime earum totam, placeat quod! Ipsa, eum' ]
	}
			...
			<React.Fragment>
				<div className="container-fluid">
					<div className="row" style={{fontFamily:'liberation_sansregular'}}>
						...
						<div className="col-lg-6 col-md-6 col-sm-12 col-12 mt-5"></div>
						<div className="col-lg-3 col-md-3 col-sm-12 col-12 mt-5">

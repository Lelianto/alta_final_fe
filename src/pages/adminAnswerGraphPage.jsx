...
class AdminLandingPage extends React.Component {
	...
	getAmount = async () => {
        const req = {
            method: "get",
            url: store.getState().baseUrl+"/admin/chart/answer",
            headers: {
				...
				<div className='container'>
					<div className='row' style={{paddingTop:'50px'}}>
						...
						<div className='col-md-2' style={{paddingLeft:'30px', paddingRight:'30px'}}>
							<div onClick={()=>this.handleChangePageMenu('/jawaban')} className='box-control btn-warning' style={{paddingBottom:'25px', paddingTop:'25px', fontSize:'12px', marginLeft:'-16px', marginRight:'-16px'}}>
								Daftar Jawaban
							</div>
                    	</div>

...
const Header = (props) => {
	if (localStorage.getItem('email') === null) {
					...
					<Link
						...
						onClick={() =>
							store.setState({
								...
								menuBarUpload: false,
								isLoading:true,
								urlProfile : 'https://kodekula.herokuapp.com/users/me'
							})}
					>
		...
		return (
			<header>
				<nav className="navbar navbar-expand-lg">
					<Link className="logo-kodekula" to="/" onClick={()=>store.setState({locationPage : null, keyword : '', urlProfile : 'https://kodekula.herokuapp.com/users/me'})}>
